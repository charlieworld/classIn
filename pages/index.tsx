...
import { NAV_ITEMS } from '../components/Header/HeaderNav';
...
export default function Index() {
    ...
    return (
      <div className="fixed top-16 p-4 w-full flex justify-center border-b-2 border-primary bg-white">
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <button
              className="w-1/2 text-lg text-primary font-bold"
              key={item.id}
  ...
  return (
    <MainLayout className="shadow">
      <>
        {renderMobileMenu()}
        <main className="mt-20 md-mt-0 py-16 md:py-24 px-10 w-full md:max-w-3xl lg:max-w-5xl">
